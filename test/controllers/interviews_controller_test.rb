...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference("Interview.count") do
      post interviews_url, params: { interview: { evaluation_summary: @interview.evaluation_summary, job_id: @interview.job_id } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { evaluation_summary: @interview.evaluation_summary, job_id: @interview.job_id } }
